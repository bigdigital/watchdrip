...
public abstract class SequenceState {
    ...
    public static final String FW_UPLOADING_FINISHED = "FW_UPLOADING_FINISHED";
    public static final String SLEEP = "SLEEP";
    public static final String FORCE_DISABLE_VIBRATION = "FORCE_DISABLE_VIBRATION";
    public static final String TRANSFER_WF_ID = "TRANSFER_WF_ID";
