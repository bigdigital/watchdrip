...
public class OperationCodes {
    ...
    public static final byte AUTH_BYTE_ALTERNATIVE = 0x00;

    public static final byte AUTH_CRYPT_FLAG = 0x00;
    public static final byte AUTH_CRYPT_FLAG_ALTERNATIVE = (byte) 0x80;

    public static final int CHUNKED_V2_ENDPOINT_AUTH = 0x82;
    public static final int CHUNKED_V2_ENDPOINT_COMPAT = 0x90;
