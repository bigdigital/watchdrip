...
public class SequenceStateBip extends SequenceState {
    public static final String WAITING_CHECKSUM_REQUEST = "WAITING_CHECKSUM_REQUEST";
    {
        sequence.add(INIT);
        ...
        sequence.add(WAITING_CHECKSUM_REQUEST);
