...
public class Const {
    ...
    public static final UUID UUID_CHARACTERISTIC_CHUNKEDTRANSFER_V2_WRITE = UUID.fromString("00000016-0000-3512-2118-0009af100700");
    public static final UUID UUID_CHARACTERISTIC_CHUNKEDTRANSFER_V2_READ = UUID.fromString("00000017-0000-3512-2118-0009af100700");
    ...
    public static final String MIBAND_NAME_6 = "Mi Smart Band 6";
    ...
    public static final String AMAZFITBIPS_NAME = "Amazfit Bip S";
    public static final String AMAZFITBIPS_LITE_NAME = "Bip S Lite";
    public static final String AMAZFITBIPU_NAME = "Amazfit Bip U";
